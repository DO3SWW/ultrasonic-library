...
Ultrasonic ultrasonic(9, 8, 17400);   // Trig PIN, Echo Pin // Timeout 17400 µs ≈ 300 cm
...
void loop() {
   Serial.print(ultrasonic.getDistanceInCM());   // Ouptut in cm
   Serial.println(" cm" );
   delay(500);
   Serial.print(ultrasonic.getDistanceInInch());   // Output in inch
   Serial.println(" inch" );
   delay (500);  
}
